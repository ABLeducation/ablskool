...
def teacher_home(request,subject_id=None):
    ...
    "training4@thinnkware.com": "https://docs.google.com/spreadsheets/d/1Q3ssGySz77GyzAX6zETa84Kue_etnNX2/edit",
    "training5@thinnkware.com": "https://docs.google.com/spreadsheets/d/1EnxRAMA39cXEJ1_BDcevhkUf42tUyxQH/edit",
    "training6@thinnkware.com": "https://docs.google.com/spreadsheets/d//edit",
    "training7@thinnkware.com": "https://docs.google.com/spreadsheets/d/1yl4mfYS9qAtSi6JtjjQL6A2_mCpzCQcm0wQHSl-meYE/edit",
    ...
    "training10@thinnkware.com": "https://docs.google.com/spreadsheets/d/1Q3ssGySz77GyzAX6zETa84Kue_etnNX2/edit",
    "training11@thinnkware.com": "https://docs.google.com/spreadsheets/d/1HSCRazedpWJ9Hc7y1womiB4JBKtW3SJYA1S4FILN_4A/edit",
    "training12@thinnkware.com": "https://docs.google.com/spreadsheets/d//edit",
    "training13@thinnkware.com": "https://docs.google.com/spreadsheets/d//edit",
...
#         students_gradewise = [(student.grade, [student], 1) for student in students]  # Group by individual student if searching
...
def upload_micro_plan(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            microplanner_instance.user = request.user
...
def view_macroplanner(request):
    macroplanners = Macroplanner.objects.filter(user=request.user).order_by('grade')
    return render(request, 'teacher_template/view_macroplanner.html', {'macroplanners': macroplanners})
    
def view_microplanner(request):
    microplanners = Microplanner.objects.filter(user=request.user)
