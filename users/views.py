...
def user_logout(request):
    ...
    #     logger.info(f'Login time fetched for user: {user.username} is {login_time}')
    ...
    #             last_login_activity.time_spent = total_time_spent
    #             last_login_activity.save()
    #             logger.info(f'Logout time recorded for user: {user.username} at {logout_time}, total time spent: {total_time_spent}')
    #             logger.info(f'Save operation successful for user: {user.username}, last_login_activity: {last_login_activity}')
    #         else:
    #             logger.warning(f'Login time is None for user: {user.username}')
    #     else:
    #         logger.warning(f'No login activity found for user: {user.username}')
    # except UserActivity1.DoesNotExist:
    #     logger.error(f'No login activity found for user: {user.username}')
    # except Exception as e:
    #     logger.error(f'Error updating logout time for user: {user.username}, error: {e}')
