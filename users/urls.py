...
urlpatterns = [
    ...
    path('student_activity/<int:user_id>/', SchoolView.student_activity_view, name='student_activity'),
    ...
    path('performance-chart/<int:user_id>/', SchoolView.observation_performance_chart, name='observation_performance_chart'),
